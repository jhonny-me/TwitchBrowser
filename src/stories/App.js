        ...
        return (
            <div className="container">
                <div className="header">
                    ...
                    <button className="labelAll selected" id="all" onClick={this.handleStatusChange}>all</button>
                    <button className="labelOnline" id="online" onClick={this.handleStatusChange}>online</button>
                    <button className="labelOffline" id="offline" onClick={this.handleStatusChange}>offline</button>
                </div>
